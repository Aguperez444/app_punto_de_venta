...
class CommonWindowInitController:
    ...
    @staticmethod
    def calculate_popup_resolution(parent_window):
        ...
        # Calcular tamaño del popup (mitad del padre)
        ancho = parent_width // 2
        alto = parent_height // 2

        # Calcular posición centrada respecto al padre
        x = parent_x + (parent_width - ancho) // 2
        y = parent_y + (parent_height - alto) // 2
