...
class ConfigFilesPersistence:
    ...
    def get_ruta_documents():
        ...
        y crea la sub carpeta 'catálogo' si no existe.
        """
        ...
        if sys.platform.startswith('linux'):
            ...
            try:
                ...
                print(e) # TODO IMPLEMENTAR LOGGER
                pass
    ...
    def encontrar_ruta_icono():
        if getattr(sys, 'frozen', False) and hasattr(sys, '_MEIPASS'):
            ...
            base_path = getattr(sys, "_MEIPASS", os.path.abspath("../resources/static/"))
        else:
            # En el caso de ejecutar directamente el script
            base_path = os.path.abspath("./app/infrastructure/resources/static/")
